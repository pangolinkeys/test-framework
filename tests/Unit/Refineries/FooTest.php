...
use Pangolinkeys\TestFramework\Tests\Example\Refineries\Foo;

class FooTest extends RefineryTestCase
{
    ...
    {
        return \Pangolinkeys\TestFramework\Tests\Example\Eloquent\Models\Foo::class;
    }
